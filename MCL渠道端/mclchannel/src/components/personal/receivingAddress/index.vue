...
.adress_chose span{
  ...
  color: #404040;
  width: 0.9rem;
  background: url("https://resource.jtsc.club/select@2x.png") no-repeat;
  background-size: 0.2rem;
  background-position: left center;
  text-align: right;
}
.adress_chose span.actives{
  background: url("https://resource.jtsc.club/select_click@2x.png") no-repeat;
  background-size: 0.2rem;
  background-position: left center;
}
.adress_chose ul{
...
.adress_chose ul li{
  ...
  background: url("https://resource.jtsc.club/bianji_add@2x.png") no-repeat;
  background-size: 0.2rem;
  background-position: 0.05rem center;
}
.adress_chose ul li:nth-child(2){
  background: url("https://resource.jtsc.club/delete_add@2x.png") no-repeat;
  background-size: 0.2rem;
  background-position: 0.05rem center;
}
</style>
