<template>
  <div class="achievement_root padding-header">
    <mt-header title="好友业绩" style="position: fixed;top: 0;width: 100%;">
      <div slot="left">
        <header-back>
    ...
    <div id="navbar" class="borderBottom">
      <mt-navbar v-model="selected">
        ...
        <mt-tab-item id="tab1" @click.native="tabClick('2')"><p>直推明细</p></mt-tab-item>
...
<script>
  ...
  export default {
    ...
    mounted(){
      let sKey = this.$route.params.friendsKey;
      this.param.friendskey=sKey;
    },
    components:{
      monthPicker,
      loadMore
