...
<div class="padding-header person_data_root">
  ...
  <div id="navbar" class="borderBottom" style="margin-top: 0.06rem;">
    <mt-navbar v-model="selected">
      <mt-tab-item id="tab0" @click.native="tabClick('1')"><p>个人业绩</p></mt-tab-item>
      <mt-tab-item id="tab1" @click.native="tabClick('2')"><p>团队业绩</p></mt-tab-item>
      <mt-tab-item id="tab2" @click.native="tabClick('3')"><p>社区业绩</p></mt-tab-item>
    </mt-navbar>
  </div>
  ...
  <loadMore :param="param" @triggerGetList="getList" ref="loadMoreE" class="padding-footer">
    <div slot="content">
      <mt-cell v-for="(item,index) in list" title="+200" label="2018.04.16 14:23" :key="index" class="borderBottom">
