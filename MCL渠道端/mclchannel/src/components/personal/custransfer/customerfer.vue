...
export default {
  ...
  methods: {
    ...
    okcust () {
	  let url = 'UserInterface/channel/ChannelCustomerTransfer.ashx'
	  let param = {
		  oldTransferUserKey: this.opkey,
		  newTransferUserKey: this.list[this.current].skey
	  }
  ...
  created () {
  	this.opkey = this.$route.query.opkey
  }
}
</script>
