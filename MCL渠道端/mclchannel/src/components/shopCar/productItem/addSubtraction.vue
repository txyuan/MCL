...
<style scoped lang="scss">
  ...
  .add,.subtraction{
      ...
      background: url("https://resource.jtsc.club/jia_yes@3x.png") no-repeat center;
  ...
  .add{
    ...
    &.no{
      background-image: url("https://resource.jtsc.club/jia_no@3x.png");
    }
  }
  .subtraction{
    border-right: 1px solid $boderE;
    background-image: url("https://resource.jtsc.club/jian_yes@3x.png");
    &.no{
      background-image: url("https://resource.jtsc.club/jian_no@3x.png");
    }
  }
