      ...
      <div class="marginHeader">
        ...
        <div class="person">
          ...
          <div class="price-area">
            <p class="clear"><span class="float_left">商品金额：</span><span class="themeRed float_left" style="padding-top:0.02rem;">¥{{orderInfo.goodsAmount}}</span> </p>
          </div>
					<div class="price-area" style="margin: 0.08rem 0 0 0;">
					...
					<div class="fried_phone" style="margin: 0.07rem 0 0 0;border-top: 1px solid #eee">
            <label>支付密码：</label>
...
<script>
    ...
    import productContent from "./../personal/myCollage/productContent.vue";
		import juanj from '@/assets/images/zhifu_bao@2x.png'
		import w_yue from '@/assets/images/zhifu_weixin@2x.png'
		import wod_yue from '@/assets/images/wodeyue@2x.png'
    export default {
        name: "index",
        data:()=>({
          note:"",
					isShow:false,  //显示隐藏支付方式
					payList:[{imgs:juanj,names:'支付宝支付',ptype:2},{imgs:w_yue,names:'微信支付',ptype:1},{imgs:wod_yue,names:'余额支付',ptype:1}],
					isShowpay:0,
					paymoney:"余额支付",  //支付方式
					payFlag:1,
					ABflag:'',
