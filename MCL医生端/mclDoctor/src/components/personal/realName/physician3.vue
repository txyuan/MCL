<template>
    ...
    <div class="mains">
      ...
      <div class="img_wrap">
        <div class="tits"><em></em>请上传个人照片 </div>
        <div class="img text-center" style="margin-bottom: 10px">
          <div class="defaultImg" v-if="isShowDefalutIdCardA">
            <img :src="idCardA" alt="">
            <p style="color: #787878"> <img src="../../../assets/images/paizhao@2x.png" style="height: 0.33rem;width: 0.46rem; margin: 0;display: block;margin: 0 auto 0.1rem auto;"/>个人照片</p>
          </div>
