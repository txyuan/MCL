<template>
    <div class="city_picker_root">
      <mt-popup v-model="showPicker" position="bottom" class="mint-popup-city">
        ...
        methods: {
          onValuesChange(picker, values) {
            ...
            if(pCode != this.provinceCode){
              ...
              //let index = this.findProvinceIndex(pCode);   //获取省的下标
            ...
            if((cityCode != this.cityCode)){
              ...
              //let contryIndex = this.findCountyIndex(adrData[index].children,cityCode);  //获取城市的下标
              //县
          ...
          confirm(){
            ...
            let values = [cityPicker.getSlotValue(0),cityPicker.getSlotValue(1),cityPicker.getSlotValue(2)];
