<template>
  <div class="home">
     <mt-header title="体力评估" fixed class="mt_header">
      <div slot="left">
        <header-back>
    ...
    <div class="title_img">
      <img src="@/assets/images/gauge_wellom/physicalGauge/title.png" alt="" />
    </div>
    <div class="content">
      <img src="@/assets/images/gauge_wellom/physicalGauge/time.png" alt="" />
      <img
        src="@/assets/images/gauge_wellom/physicalGauge/jieshao.png"
        alt=""
      />
      <img
        src="@/assets/images/gauge_wellom/physicalGauge/jieshao2.png"
        alt=""
      />
      <img src="@/assets/images/gauge_wellom/physicalGauge/huode.png" alt="" />
      <img src="@/assets/images/gauge_wellom/physicalGauge/lilun.png" alt="" />
      <img src="@/assets/images/gauge_wellom/physicalGauge/xuzhi.png" alt="" />
      <img
        src="@/assets/images/gauge_wellom/physicalGauge/wenxian.png"
        alt=""
      />
    </div>
...
export default {
  ...
  methods: {
    goInfo() {
      this.$router.push("/physicalGauge1");
    },
