  ...
  <div class="home">
    ...
    <div>
     ...
     <div class="gauge_3">
         ...
         <p style="margin-top:0.4rem;">2、您白天需要待在床上或椅子上吗？</p>
           <van-radio-group  class="one_gau_radio gebie_radio" v-model="data.value_02" direction="horizontal">
            <van-radio
         ...
         <p style="margin-top:0.4rem;">3、户外短距离行走需要休息多久？</p>
  ...
  watch: {
     aaa: {
      ...
      handler(newVal, oldVal) {
        if (newVal.value_01 == "" || newVal.value_02 == "" || newVal.value_03 == "") {
          this.valueAll = false
        }else {
          this.valueAll = true
        }
