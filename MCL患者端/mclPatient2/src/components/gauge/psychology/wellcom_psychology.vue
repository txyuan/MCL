<template>
  <div class="home">
     <mt-header title="心理评估" fixed class="mt_header">
      <div slot="left">
        <header-back>
    ...
    <div class="title_img">
      <img src="@/assets/images/gauge_wellom/psychology/title.png" alt="" />
    </div>
    <div class="content">
      <img src="@/assets/images/gauge_wellom/psychology/time.png" alt="" />
      <img
        v-if="!jieshaoImg"
        src="@/assets/images/gauge_wellom/psychology/jieshao.png"
        @click="changeImg"
        alt=""
      />
      <img
        v-else
        src="@/assets/images/gauge_wellom/psychology/jieshaoMore.png"
        @click="changeImg"
        alt=""
      />
      <img src="@/assets/images/gauge_wellom/psychology/jieshao2.png" alt="" />
      <img src="@/assets/images/gauge_wellom/psychology/huode.png" alt="" />
      <img src="@/assets/images/gauge_wellom/psychology/lilun.png" alt="" />
      <img src="@/assets/images/gauge_wellom/psychology/xuzhi.png" alt="" />
