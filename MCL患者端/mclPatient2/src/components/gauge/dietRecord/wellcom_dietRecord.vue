<template>
  <div class="home">
     <mt-header title="饮食监测" fixed class="mt_header">
      <div slot="left">
        <header-back>
    ...
    <div class="title_img">
      <img src="@/assets/images/gauge_wellom/dietRecord/title.png" alt="" />
    </div>
    <div class="content">
      <img src="@/assets/images/gauge_wellom/dietRecord/time.png" alt="" />
      <img
        v-if="!jieshaoImg"
        src="@/assets/images/gauge_wellom/dietRecord/jieshao.png"
        @click="changeImg"
        alt=""
      />
      <img
        v-else
        src="@/assets/images/gauge_wellom/dietRecord/jieshaoMore.png"
        @click="changeImg"
        alt=""
      />
      <img src="@/assets/images/gauge_wellom/dietRecord/jieshao2.png" alt="" />
      <img src="@/assets/images/gauge_wellom/dietRecord/huode.png" alt="" />
      <img src="@/assets/images/gauge_wellom/dietRecord/lilun.png" alt="" />
      <img src="@/assets/images/gauge_wellom/dietRecord/xuzhi.png" alt="" />
      <img src="@/assets/images/gauge_wellom/dietRecord/wenxian.png" alt="" />
    </div>
