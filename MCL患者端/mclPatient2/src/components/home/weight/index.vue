      ...
      <div class="mag10 bg-white">
        ...
        <div class="btns">
          ...
          <mt-button
            ...
            class="theme-button button-radio"
            size="large"
            @click.native="$router.push({ name: 'dietCase' })"
              ...
              <div slot="content">
                ...
                <div v-for="(item, index) in list" :key="index">
                  <div class="flex ac Dark" style="color: #333">
                    ...
                    >
                      <i
                        v-show="item.Difference < 0"
                        class="icon iconfont icon-icon_xiangxiajiantoucuxiao"
                      ></i>
                      <i
                        v-show="item.Difference > 0"
                        class="icon iconfont icon-icon_xiangshangjiantoucuxiao"
                      ></i>
                      {{
                        item.Difference.includes("-")
                          ? item.Difference.substr(1)
                          : item.Difference
                      }}Kg
                    </div>
                  </div>
...
.close {
  width: 0.2rem;
  height: 0.2rem;
  background: url(./../../../assets/images/guanbi@2x.png) no-repeat center
    center;
  background-size: 100%;
  position: absolute;
  right: 0.14rem;
