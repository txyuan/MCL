...
<div>
  <div class="yinshhi_list" style="padding-bottom: 0.5rem;">
    ...
    <!-- 没有数据显示介绍页面 -->
    <div class="" v-if="dataflag==0">
      <img src="@/assets/images/welysfa.jpg" style="width: 100%;" />
    </div>
    
    <!-- 有数据但后台没有制作方案，正在制作中页面 -->
    <div class="noalready" v-if="dataflag==2">
...
<!--                      <img src="@/assets/images/tanshuihuahewu@2x.png" alt=""/>-->
    ...
    <router-link v-if="(dataflag==0) || (dataflag==2)" to="/gauge_diet?resetstatus=1" class="buttons">
        <mt-button type="danger" class="add_btns" size="large">
          <span v-if="dataflag==0">饮食处方</span>
          <span v-else>调整处方</span>
        </mt-button>
    </router-link>
  </div>
