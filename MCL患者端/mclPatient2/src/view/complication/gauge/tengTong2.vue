...
export default {
    data() {
        ...
        return {
            ...
            rangeValue: 0,
            list: [
				{name: "无症状", value: "0"}, {name: "非常轻微", value: "1"}, {name: "稍微有", value: "2"}, {name: "有点痛", value: "3"}, {name: "中等程度", value: "4"},
				{name: "较明显不适", value: "5"}, {name: "一般痛", value: "6"}, {name: "比较痛", value: "7"}, {name: "非常痛", value: "8"}, {name: "特别痛", value: "9"},
				{name: "极痛", value: "10"},
			]
        }
    },
