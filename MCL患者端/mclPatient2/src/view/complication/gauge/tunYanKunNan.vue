...
export default {
    data() {
        ...
        return {
            ...
            rangeValue: 0,
            list: [
				{name: "完全不能进食，不适合做吞咽训练", value: "0"}, {name: "吞咽困难或不能吞咽，不适合做吞咽训练", value: "1"}, {name: "大量误吸，吞咽困难或不能吞咽，适合做吞咽基础训练", value: "2"}, {name: "如做好准备可减少误吸，可进行进食训练", value: "3"}, {name: "作为兴趣进食可以，但营养摄取仍需非口途径", value: "4"},
				{name: "仅1～2顿的营养摄取可经口", value: "5"}, {name: "3顿的营养摄取均可经口，但需补充辅助营养", value: "6"}, {name: "如为能吞咽的食物，3顿均可经口摄取", value: "7"}, {name: "除少数难吞咽的食物，3顿均可经口摄取", value: "8"}, {name: "可吞咽普通食物但需给予指导", value: "9"},
				{name: "进食，吞咽能力正常", value: "10"},
			]
        }
    },
	computed:{
