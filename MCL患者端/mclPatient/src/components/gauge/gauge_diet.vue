<template>
	<div class="PG-SGA-root padding-header padding-footer">
		<mt-header title="饮食处方" fixed class="borderBottom">
			<div slot="left">
				<header-back>
		...
		<div>
			...
			<div class="title2 yellow bg-white">1.您目前是否可以进食？</div>
			<mt-radio :options="eatingflagRadiolist.option" v-model="param.eatingflag" class="borderBottom radio-nowrap"></mt-radio>
			<div class="title2 yellow bg-white">2.您的饮食状况：</div>
			<mt-radio :options="dietarysituationRadiolist.option" v-model="param.dietarysituation" class="borderBottom"></mt-radio>
			<div class="title2 yellow bg-white">3.您是否有其他营养来源？</div>
			<mt-radio :options="nutrientsourcesRadiolist.option" v-model="nutrientsourcesRadiolist.value" class=""></mt-radio>
			<div class="title2 bg-white" style="line-height: 48px;padding-left: 20px;" v-show="this.nutrientsourcesRadiolist.show1">
				口服营养制剂 <input type="text" class="line-input" placeholder=""  v-model="param.nutrientsources03"> Kcal 
			</div>
			<div class="title2 bg-white" style="line-height: 48px;padding-left: 20px;" v-show="this.nutrientsourcesRadiolist.show2">
			...
			<div class="title2 yellow bg-white">4.目前的活动状态</div>
			<mt-radio :options="coefficienttypeRadioList.option" v-model="param.coefficienttype" class="borderBottom radio-nowrap"></mt-radio>
			
			<div class="title2 yellow bg-white">5.饮食习惯</div>
			<mt-checklist :options="eatinghabitsRadiolist.option" v-model="eatinghabitsRadiolist.value" class="borderBottom"></mt-checklist>
			<!-- <div class="title2 yellow bg-white">6.食物喜好</div>
			...
			<div class="title2 bg-white borderBottom margin10" style="line-height: 1.5;">
			...
			<div class="title2 yellow bg-white">6.食物喜好</div>
			<div class="title2 bg-white" style="line-height: 48px;padding-left: 20px;">
				最爱吃的食物 <input type="text" class="line-input" v-model="param.foodpre01">, 
			</div>
			<div class="title2 bg-white" style="line-height: 48px;padding-left: 20px;">
				现在能吃<input type="tel" class="line-input" v-model="param.foodpre02">两。
			</div>
			...
			<div class="title2 yellow bg-white">12.饮食禁忌</div>
			...
			<div class="fix_bottom fix_bottom_area">
				<mt-button type="primary" class="theme-button button-radio" size="large" @click.native="submit">生成处方</mt-button>
			</div>
		</div>
	</div>
</template>
...
//			},
			...
			eatinghabitsRadiolist: {
				...
				option: [{label: '荤素均衡', value: "01"}, {label: '荤食为主', value: "02"}, {label: '素食为主', value: "03"}, {label: '嗜盐', value: "04"}, {label: '嗜油', value: "05"}, {label: '嗜糖', value: "06"}],
				value: [],
				checklist: true
			},
		}),
