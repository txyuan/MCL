<template>
    <div class="padding-header">
      ...
      <div class="recharge_cont">
        <h2>充值金额</h2>
        <p>¥ <input type="tel" v-model="moneyc"/></p>
        <ul>
...
//          { pic: require("@/assets/images/wechat_zhifu@2x.png"),pay:'微信支付',id:0},
            { pic: require("@/assets/images/zhifu_bao@2x.png"),pay:'支付宝支付',id:1}
          ]
        }),
        methods:{
          addClassFun: function(index,item) {
            this.isActive = index;
            this.moneyc = item.ShowContent;
          },
          ...
          getmoney(){
            ...
            this.$post(url).then((data)=>{
              ...
              this.moneyc=data.data[0].ShowContent;
            })
          },
          //余额充值
          getRecharge(){
...
<style scoped lang="scss">
  ...
  /*.recharge_cont ul li:before{*/
    ...
    /*height: 100%;*/
  /*}*/
  .recharge_cont ul li:nth-child(1),.recharge_cont ul li:nth-child(4){
    margin-left: 0;
  }
  ...
  .recharge_cont ul li.act span,.recharge_cont ul li.act label{
    color: #FF1E41;
  }
 .note{
   font-size: 0.14rem;
