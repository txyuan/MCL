<template>
	<div class="symptom-root rangid">
        ...
        <tr class="bhistory">
			...
			<mt-popup class="mint-popup-3" v-model="popupVisible" position="right" :modal="false" popup-transition="popup-fade">
				...
				<div class="popup_body" ref="popupBody">
					<div class="content04 abcd">
						<div class="valurang" v-if="(rgid==33)||(rgid==34)||(rgid==17)||(rgid==39)||(rgid==42)||(rgid==46)">
							...
							<div class="fszrg">
								<h3>严重程度</h3>
								<mt-range v-model="ttvalue" :min="0" :max="10" :step="1" :bar-height="10" @change="aa">
								</mt-range>
								<ul class="rangeNum">
									<li>0</li>
									<li>1</li>
  ...
  export default {
    ...
    data: () => ({
      ...
      ids: [
        ...
        {id: 'attribute_value_01', itemindex: '32', name: '贫血', states: ''},
        {id: 'attribute_value_02', itemindex: '33', name: '疼痛', states: ''},
		{id: 'attribute_value_03', itemindex: '17', name: '吞咽困难', states: ''},
        {id: 'attribute_value_04', itemindex: '34', name: '食欲下降、厌食', states: ''},
        {id: 'attribute_value_05', itemindex: '11,12,37', name: '恶心呕吐', states: ''},
        {id: 'attribute_value_06', itemindex: '36', name: '消化不良', states: ''},
		{id: 'attribute_value_07', itemindex: '48', name: '腹泻', states: ''},
        {id: 'attribute_value_08', itemindex: '39', name: '化疗后腹胀', states: ''},
		{id: 'attribute_value_09', itemindex: '44', name: '便秘', states: ''},
		{id: 'attribute_value_10', itemindex: '46', name: '疲劳', states: ''},
		{id: 'attribute_value_11', itemindex: '18', name: '睡眠障碍(失眠)', states: ''},  //修改问题了
		{id: 'attribute_value_12', itemindex: '41', name: '白细胞减少', states: ''},
		{id: 'attribute_value_13', itemindex: '54', name: '低蛋白血症', states: ''},   //新加问题
		{id: 'attribute_value_14', itemindex: '31', name: '体重丢失', states: ''},
		{id: 'attribute_value_15', itemindex: '49', name: '放射性肺炎', states: ''},   //新加弹窗
		{id: 'attribute_value_16', itemindex: '45', name: '口腔溃疡', states: ''},
		{id: 'attribute_value_17', itemindex: '50', name: '血小板减少', states: ''},   //新加问题
		{id: 'attribute_value_18', itemindex: '52', name: '放射性肠炎', states: ''},  //47新加问题
		{id: 'attribute_value_19', itemindex: '53', name: '肺部感染', states: ''},  //新增项
        {id: 'attribute_value_20', itemindex: '40', name: '肢体肿胀', states: ''},
		{id: 'attribute_value_21', itemindex: '42', name: '脱发', states: ''},
    ...
    methods: {
	  ...
	  getchoose () {
	    ...
	    this.$post(url, param).then((data) => {
		  ...
		  this.itmekey = data.skey
	      this.ids[0].states = data.attribute_value_01
	      this.ids[1].states = data.attribute_value_02
	      this.ids[2].states = data.attribute_value_03
	      this.ids[3].states = data.attribute_value_04
	      this.ids[4].states = data.attribute_value_05
	      this.ids[5].states = data.attribute_value_06
	      this.ids[6].states = data.attribute_value_07
	      this.ids[7].states = data.attribute_value_08
	      this.ids[8].states = data.attribute_value_09
	      this.ids[9].states = data.attribute_value_10
	      this.ids[10].states = data.attribute_value_11
	      this.ids[11].states = data.attribute_value_12
	      this.ids[12].states = data.attribute_value_13
	      this.ids[13].states = data.attribute_value_14
	      this.ids[14].states = data.attribute_value_15
	      this.ids[15].states = data.attribute_value_16
	      this.ids[16].states = data.attribute_value_17
	      this.ids[17].states = data.attribute_value_18
	      this.ids[18].states = data.attribute_value_19
	      this.ids[19].states = data.attribute_value_20
	      this.ids[20].states = data.attribute_value_21
	    })
	  },
      toggleModal (type) {
