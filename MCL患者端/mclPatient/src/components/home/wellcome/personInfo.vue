<template>
	<div class="personInfo_root padding-header padding-footer">
		...
		<!-- 时间picker -->
		<mt-datetime-picker ref="DatetimePicker" @change="visbleChange" type="date" :startDate="new Date(new Date().setFullYear(new Date().getFullYear() - 90))"
		 :endDate="new Date(new Date().setFullYear(new Date().getFullYear() + 3))" :value="new Date()" year-format="{value} 年"
