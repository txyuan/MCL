									...
									<ul class="clear">
										<router-link tag="li" to="/gauge_PG_SGA" class="float_left">
											<div class="li-inner clear">
												...
												<div class="float_left imgwrap">
													<img src="@/assets/images/筛选@2x.png" width="39" />
												</div>
											</div>
										</router-link>
										<li class="float_left">
											<div class="li-inner clear">
												...
												<div class="float_left imgwrap">
													<img src="@/assets/images/guanlitaocan.png" width="39" />
												</div>
											</div>
										</li>
										...
										<router-link tag="li" to="/menuRecog" class="float_left">
											<div class="li-inner clear">
												...
												<div class="float_left imgwrap">
													<img src="@/assets/images/笔记@2x.png" width="39" />
												</div>
											</div>
										</router-link>
									</ul>
