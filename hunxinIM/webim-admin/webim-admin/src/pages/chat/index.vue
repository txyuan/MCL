      	...
      	<div class="cell huanzhe" v-show="doctorInfo.flag == 0">
            ...
            <div class="btn—wrap">
      				<el-row>
							  ...
							  <el-button size="mini" type="primary" @click="sendIframe('饮食处方', `/Pages/PatientManage/DietarySurveyList.aspx?patient_skey=${huanzheInfo.patientkey}&headerSkey=undefined`)">饮食处方</el-button>
